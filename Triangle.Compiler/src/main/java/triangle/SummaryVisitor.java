...
/**
 * Implements an AST visitor that summarises a program
 */
...
/**
 * Print summary statistics for the AST that was visited.
 */
public void printStatistics() {
    System.out.println("=== Program Statistics ===");
    System.out.println("--  Number of binary expressions: " + numBinaryExpressions);
    System.out.println("--  Number of if commands: " + numIfCommands);
    System.out.println("--  Number of while commands: " + numWhileCommands);
}
	...
	public AbstractSyntaxTree visitBinaryExpression(BinaryExpression ast, Void arg) {
            numBinaryExpressions++; // Count this expression
		ast.E1.visit(this);
		ast.E2.visit(this);
		ast.O.visit(this);
		return null;
	...
	public AbstractSyntaxTree visitIfCommand(IfCommand ast, Void arg) {
            numIfCommands++; // Count the command
		ast.C1.visit(this);
		ast.C2.visit(this);
		AbstractSyntaxTree replacement = ast.E.visit(this);
		if (replacement != null) {
	...
	public AbstractSyntaxTree visitWhileCommand(WhileCommand ast, Void arg) {
            numWhileCommands++; // Count the command
		ast.C.visit(this);
		AbstractSyntaxTree replacement = ast.E.visit(this);
		if (replacement != null) {
			ast.E = (Expression) replacement;
